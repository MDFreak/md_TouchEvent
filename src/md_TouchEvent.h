/* @file    md_Touchevent.h
 * @author  Martin Dorfner
 * @contact inbox@martin-dorfner.at
 * @version 0.1
 *
 * @description
 * | md_Touchevent - for further extension -
 * | is forked from file Touchevent.h / version 0.1
 * | author Gerald Lechner / contact lechge@gmail.com
 * |
 ...
 * #
 */
#ifndef _MD_TOUCHEVENT_H_
  #define _MD_TOUCHEVENT_H_
  #include <Arduino.h>
